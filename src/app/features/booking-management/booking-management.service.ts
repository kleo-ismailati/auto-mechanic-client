...
export class BookingManagementService {
  ...
  postUpdatedBooking(bookingId: number, updatedBooking: Booking): Observable<any> {
    return this.api.put(environment.bookings_url + '/' + bookingId, updatedBooking)
  }
  ...
  postNewRepair(bookingId: number, newRepair: RepairCreate): Observable<any> {
    return this.api.post(environment.add_repair_url + '/' + bookingId, newRepair)
  }

  postUpdatedRepair(repairId: number, updatedRepair: Repair): Observable<any> {
    return this.api.put(environment.repairs_url + '/' + repairId, updatedRepair);
  }
